            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="login.html"><i class="fas fa-sharp fa-solid fa-plus"></i>&nbsp;Novo Cliente</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Outras Paginas:</h6>
                        <a class="collapse-item" href="404.html"><i class="fas fa-user-md"></i>&nbsp;Verificar por Médico</a>
